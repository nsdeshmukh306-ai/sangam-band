...
- [ ] Phase 1 — Core agents (`@Intake`, `@PatientProfile`, `@StructuralBio`)
...
(Phase 1+ will add tests under `tests/` for the PK/PD model, PGx rules, docking
lookup, PubChem wrapper, and RAG retrieval — all runnable without live Band/DeepSeek
credentials.)
